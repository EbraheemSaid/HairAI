...
public class ManuallyActivateSubscriptionCommandValidator : AbstractValidator<ManuallyActivateSubscriptionCommand>
{
    public ManuallyActivateSubscriptionCommandValidator()
    {
